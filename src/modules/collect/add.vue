            ...
            handleSubmit(ev) {
                ...
                this.$refs.webFrom.validate((valid) => {
                    if (valid) {
                        ...
                        collect.set(_vm.webFrom);
                        collect.set("tag",_vm.currentTag);
                        ...
                        collect.save(null, {
                            success: function (web) {
                                ...
                                try{
                                    _vm.$store.dispatch('postCollect',  web.toJSON()
                               ...
                               // _vm.$dispatch("addItem", web.toJson());
                                ...
                                //_vm.$parent.$parent.items.push(web.toJson())
//                                _vm.$parent.$parent.$refs.webDialog.close()
                               // alert(_vm.postCollect)
                         // _vm.postCollect(web.toJson())
//                                _vm.$store.dispatch('postCollect', {
//                                    data: web.toJson(),
//
//                                })
